...
public class AgregarMiembroService implements AgregarMiembroUseCase {
    ...
    public MiembroDTO agregarMiembro(AgregarMiembroCommand command) {
        ...
        // ── El constructor de Usuario valida nombre y correo.
        // Hogar.agregarMiembro() valida duplicados, formato de correo y asigna el hogar.
        ...
        // Recuperar el miembro recién persistido para obtener su id generado por la BD
